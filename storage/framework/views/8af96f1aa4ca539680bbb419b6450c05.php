...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Wood House Shop - Wooden Houses and Saunas'); ?></title>
    <script src="https://cdn.tailwindcss.com"></script>
    <meta name="description" content="<?php echo $__env->yieldContent('description', 'Quality wooden houses and saunas for your perfect home'); ?>">
</head>
            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    <a href="/cart" class="relative p-2 text-gray-700 hover:text-amber-600 transition-colors">
                        ...
                        <span class="absolute -top-1 -right-1 bg-amber-600 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center">0</span>
                    </a>
